...
\textbf{Expected results.} ThermoRG-MF will identify architectures achieving $E_{\mathrm{floor}} \leq 0.87$ (comparable to TN-W32) at $\sim$20\% of the random search compute budget. Key to the improvement: the $J_{\mathrm{topo}} \to E_{\mathrm{floor}}$ channel ($r = 0.83$) provides a zero-cost first screening pass that eliminates poorly-performing architectures before any training begins.
