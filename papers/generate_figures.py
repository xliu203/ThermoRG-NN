...
ax.set_title("(a)  D-scaling: loss vs width\n(LN, BN, None configs)", fontsize=10, fontweight="bold")
...
ax.set_title("(b)  Residuals after\nsubtracting E_floor", fontsize=10, fontweight="bold")
ax.legend(fontsize=8, loc="upper right")
ax.set_xticks([32, 48, 64, 96])
ax.set_xlim(25, 120)
ax.axhline(0, color="gray", linestyle="--", linewidth=1.0, alpha=0.5)
...
ax.set_title("(c)  R² for each config\n(all > 0.99)", fontsize=10, fontweight="bold")
