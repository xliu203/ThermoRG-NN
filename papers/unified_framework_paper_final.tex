...
\begin{equation}
\boxed{\beta = \beta_0 \cdot (0.87)^{\,n_s}}.
\end{equation}
The factor $0.87$ is the \textbf{scaling dimension} of the stride-2 perturbation ($\Delta_{\mathrm{stride}} = -\ln 0.87 \approx 0.20$), calibrated from ResNet-18 data.

For max-pooling with its larger effective block size, the suppression factor per layer is approximately $(0.87)^2 \approx 0.76$.
